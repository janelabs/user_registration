...
/*
 * This file is part of the Pagerfanta2 package.
 *
...
class Paginator implements \Countable, \IteratorAggregate
{
    ...
    public function count()
    {
        ...
        $countQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Pagerfanta2\Adapter\DoctrineORM\CountWalker'));
    ...
    public function getIterator()
    {
        ...
        if ($this->fetchJoinCollection) {
            ...
            $subQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Pagerfanta2\Adapter\DoctrineORM\LimitSubqueryWalker'))
            ...
            if (count($ids) > 0) {
                ...
                $whereInQuery->setHint(Query::HINT_CUSTOM_TREE_WALKERS, array('Pagerfanta2\Adapter\DoctrineORM\WhereInWalker'));
